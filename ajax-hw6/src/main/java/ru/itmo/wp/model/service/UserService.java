...
public class UserService {
    ...
    public void setAdmin(long changerId, boolean isAdmin, long changingId) throws ValidationException{
        User changer = userRepository.find(changerId);
        if (changer.isAdmin()) {
            userRepository.setAdmin(changingId, isAdmin);
        } else {
            throw new ValidationException("You should be an admin to change it!");
        }
    }
}
